            ...
            <div class="d-block d-md-none">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <li><a class="dropdown-item" href="#" data-bs-target="#createDataKaryawan" data-bs-toggle="modal">
                            <i class="bi bi-plus-circle"></i><span>Tambah</span></a>
                    </li>
                </ul>
            </div>
            ...
            <form action="{{ route('datakaryawan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mt-1">
                        ...
                        <input class="form-control @error('keahlian') is-invalid @enderror" type="text" name="keahlian"
                            id="keahlianCreate" value="{{ old('keahlian') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('username') is-invalid @enderror" type="text" name="username"
                            id="usernameCreate" value="{{ old('username') }}" placeholder="Masukkan username">
                        @error('username')
                        <div class="text-danger">
                            <small>{{ $message }}</small>
                        </div>
                    ...
                    <div class="form-group mt-1">
                        ...
                        <input class="form-control @error('email') is-invalid @enderror" type="text" name="email"
                            id="emailCreate" value="{{ old('email') }}" placeholder="Masukkan email">
                        @error('email')
                        <div class="text-danger">
                            <small>{{ $message }}</small>
                        </div>
                    ...
                    <div class="form-group mt-1">
                        ...
                        <input class="form-control @error('password') is-invalid @enderror" type="password"
                            name="password" id="passwordCreate" value="" placeholder="Masukkan password" autocomplete>
                        @error('password')
                        <div class="text-danger">
                            <small>{{ $message }}</small>
                        </div>
                    ...
                    <div class="form-group mt-1">
                        ...
                        <input class="form-control @error('password_confirmation') is-invalid @enderror" type="password"
                            name="password_confirmation" id="password_confirmationCreate" value=""
                            placeholder="Masukkan password ulang" autocomplete>
...
@enderror" type="text" name="namaEdit" id="namaEdit" value="{{ old('namaEdit') }}"
...
@enderror" type="text" name="alamatEdit" id="alamatEdit" value="{{ old('alamatEdit') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('usernameEdit') is-invalid @enderror" type="text"
                            name="usernameEdit" id="usernameEdit" value="{{ old('usernameEdit') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('passwordEdit_confirmation') is-invalid @enderror"
                            type="password" name="passwordEdit_confirmation" id="passwordEdit_confirmation" value=""
